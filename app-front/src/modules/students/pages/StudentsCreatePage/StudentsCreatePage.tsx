...
import styles from "./StudentsCreatePage.module.css";
import { useCreateStudent } from "../../hooks/useStudents";
import type { StudentRequest } from "../../../../types";

const StudentsCreatePage: React.FC = () => {
      ...
      <form className={styles.studentsCreatePage__form} onSubmit={handleSubmit}>
        ...
        {step === 1 && (
          <div className={styles.studentsCreatePage__step}>
            ...
            <div className={styles.studentsCreatePage__formGroup}>
              <label>Sexo:</label>
              <select id="genderId" value={formData.genderId} onChange={handleChange} required>
        ...
        {step === 2 && (
          <div className={styles.studentsCreatePage__step}>
            ...
            <div className={styles.studentsCreatePage__formGroupCheckbox}>
              <label>
                <input
                  id="active" type="checkbox" checked={true} disabled
                /> Activo
              </label>
            </div>
          </div>
